...
from pygeodesy3 import R_M, classname, Datums, degrees, fstr, Height, modulename, \
                       rtp2xyz, xyz2rtp, RefFrames, Transforms  # PYCHOK expected
from pygeodesy3.Base.cartesian import CartesianBase, RadiusThetaPhi3Tuple
    ...
    def testCartesian(self, module, Sph=False, Nv=False, X=False):  # MCCABE 45
        ...
        if hasattr(Cartesian, 'intersections2'):
            ...
            if Sph:
                ...
                try:
                    from pygeodesy3 import trilaterate3d2  # with earth ... equivalent to Cartesian.intersections2?
        ...
        try:
            from pygeodesy3.maths.vector3d import intersections2
