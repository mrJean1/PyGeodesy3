...
class Tests(_TestsLL, _TestsV):
    ...
    def testSpherical(self, module, Sph=True, Nv=False):  # MCCABE 13
        ...
        # courtesy of U{sbonaime<https://GitHub.com/mrJean1/PyGeodesy3/issues/58>}
        ...
        if hasattr(LatLon, 'intersections2') and Sph:
            ...
            # courtesy of U{Samuel Čavoj<https://GitHub.com/mrJean1/PyGeodesy3/issues/41>}
        ...
        b = p.rhumbAzimuthTo(q)  # BACKWARD rhumbBearingTo
        self.test('rhumbAzimuthTo', b, 116.722, fmt='%.3f')  # BACKWARD rhumbBearingTo 116.7
        ...
        if hasattr(LatLon, 'nearestOn'):
            # <https://GitHub.com/mrJean1/PyGeodesy3/issues/25>
...
if __name__ == '__main__':
    ...
    from pygeodesy3.spherical import nvector as Nv, trigonometry as Tg
