...
from pygeodesy3 import mgrs, Mgrs, parseMGRS
...
class Tests(TestsBase):
    ...
    def testMgrs(self, LatLon):
        ...
        # courtesy of U{abubelinha<https://GitHub.com/mrJean1/PyGeodesy3/issues/54>}
...
#       self.test('digraph', t.digraph, t.EN)  # DEPRECATED
        ...
        # courtesy of U{CF-FHB-X<https://GitHub.com/mrJean1/PyGeodesy3/issues/70>}
