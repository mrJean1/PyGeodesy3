...
from pygeodesy3 import date2epoch, Epoch, epoch2date, F_D, F_DMS, RefFrames, TRFError
...
class Tests(TestsBase):
    ...
    def testTrf(self, ellipsoidal_):  # MCCABE 17
        ...
        x = p.toRefFrame(RefFrames.ETRF2000)
        ...
        try:
            t = LatLon(0, 0, reframe=RefFrames.ITRF2000).toRefFrame('ITRF2000')
        except TypeError as x:
            t = str(x)
...
#       try:
#           t = c.toRefFrame(RefFrames.ITRF2000, RefFrames.ITRF2000, '2000')
#       except TypeError as x:
#           t = str(x)
