...
from pygeodesy3 import Ellipsoids, EPS, F_DEG, F_DMS, fstr, parseUTM5, toUtm8, Utm
...
#       self.test('toUps', t, '00 S -7702368 -395110')  # XXX invalid?
        ...
        # courtesy of U{sumnamazu<https://GitHub.com/mrJean1/PyGeodesy3/issues/26>}
        ...
        # courtesy of U{CaipiDE<https://GitHub.com/mrJean1/PyGeodesy3/issues/63>} with
...
if __name__ == '__main__':
    ...
    from pygeodesy3 import ellipsoidalVincenty, utm
