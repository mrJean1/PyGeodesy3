...
#       self.test('iteration', r.iteration, r.iteration)
    ...
    def testInverse(self, E, debug=False):
        ...
        P = Ellipsoid(E.b, E.a, name='_Prolate').rhumbekx  # '_...' for iOS
    ...
    def testRhumbLine(self, E):
        ...
        t = R.RAorder, R.TMorder
        R.RAorder, R.TMorder = 4, 8  # BACKWARD
        self.test('XXorders', str(t), '(6, 6)')
        t = R.RAorder, R.TMorder
        R.RAorder = R.TMorder = 6  # BACKWARD
        self.test('XXorders', str(t), '(4, 8)', nt=1)
...
if __name__ == '__main__':
    ...
    from pygeodesy3 import Ellipsoids
