...
class Tests(TestsBase):
    ...
    def testVectorial(self, module, Sph=False):  # MCCABE 14
        ...
        if hasattr(LatLon, 'destinationNed'):
            # courtesy of PatrikHudak <https://GitHub.com/mrJean1/PyGeodesy3/issues/72>
            from pygeodesy3 import Ned  # in .ltpTuples
    ...
    def testTrilaterate2d2(self):
        ...
        # courtesy of U{MartinManganiello<https://GitHub.com/mrJean1/PyGeodesy3/issues/49>}
    ...
    def testTrilaterate3d2(self, Vector):
        ...
        try:  # need numpy
            ...
            # coutesy Martin Manganiello <https://GitHub.com/mrJean1/PyGeodesy3/issues/49>
