...
class Tests(TestsBase):
    ...
    def testOSgr(self, module):
        ...
        # courtesy of U{jaluebbe<https://GitHub.com/mrJean1/PyGeodesy3/issues/38>}, with expected
