...
from pygeodesy3 import elevation2, Datums, geoidHeight2
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        timeout = float(os.getenv('PYGEODESY3_COVERAGE', '0'))

    if ismacOS and timeout > 4:
        from pygeodesy3 import ellipsoidalVincenty
...
#   all testElevations.py tests passed (PyGeodesy3 18.8.24 Python 2.7.15 64bit geographiclib 1.49 numpy 1.14.0 macOS 10.13.6) 5.757 sec
...
#   test 32 geodHeight2: (None, "URLError(timeout('timed out'))")
#
#   all testElevations.py tests passed (PyGeodesy3 18.8.26 Python 3.7.0 64bit macOS 10.13.6) 8.479 sec
...
#   test 32 geodHeight2: (None, "URLError(timeout('timed out'))")
#
#   all testElevations.py tests passed (PyGeodesy3 18.8.26 Intel-Python 3.5.3 64bit numpy 1.11.3 macOS 10.13.6) 7.794 sec
...
#   all testElevations.py tests passed (PyGeodesy3 18.8.28 Python 2.7.12 64bit numpy 1.8.0 iOS 11.4.1) 11.339 sec
...
#   all testElevations.py tests passed (PyGeodesy3 18.8.28 Python 3.6.1 64bit numpy 1.8.0 iOS 11.4.1) 7.694 sec
